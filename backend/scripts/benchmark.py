...
Usage:
    ...
    ..\\.venv\\Scripts\\python.exe scripts\\benchmark.py --target dvwa
    ..\\.venv\\Scripts\\python.exe scripts\\benchmark.py --target juiceshop
    ..\\.venv\\Scripts\\python.exe scripts\\benchmark.py --target both
    ..\\.venv\\Scripts\\python.exe scripts\\benchmark.py --target http://custom-target.com --module sql_injection
"""
